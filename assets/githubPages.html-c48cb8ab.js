import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as l,c as o,b as s,d as n,e,f as p}from"./app-7d8b824e.js";const c={},r=s("h2",{id:"前言",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#前言","aria-hidden":"true"},"#"),n(" 前言")],-1),d=s("p",null,[n("个人认为，有自己的个人博客是一种很酷的象征，同时在求职的时候，也会给人留下一个良好的印象。所以我一直想搞一个自己的博客网站，但是想到搞网站还要学习 "),s("code",null,"后端知识+服务器知识"),n(" ，我就失去动力了...")],-1),u={href:"https://v2.vuepress.vuejs.org/zh/",target:"_blank",rel:"noopener noreferrer"},k=p('<ul><li>静态网站生成器（不用另外学后端知识啦）</li><li>路由会根据 Markdown 文件的相对路径来自动生成（约定式路由）</li><li>可以部署到 GitHub 上（没有自己的服务器也可以部署哇）</li><li>V2.0版本支持 <code>Vue3 + TypeScript + Vite</code> （就是你了）</li></ul><p>于是立马开始啃文档，动手搭建自己的博客网站啦！</p><blockquote><p>插播一小段感慨：说来惭愧，我是最近几天才知道 VuePress 的，但它其实在2018-4-12就发布了。我还是因为掘金文章的Markdown主题里有一个 <code>vuepress</code> 主题，觉得挺好看的，以为就是一个模仿vue官网主题的主题名而已，然后还是好奇搜了下，才发现原来有 VuePress 这个工具。</p></blockquote><h2 id="上手" tabindex="-1"><a class="header-anchor" href="#上手" aria-hidden="true">#</a> 上手</h2><h3 id="依赖环境" tabindex="-1"><a class="header-anchor" href="#依赖环境" aria-hidden="true">#</a> 依赖环境</h3>',5),v=s("code",null,"Node.js v16.19.0+",-1),m={href:"https://www.cnblogs.com/dreamsqin/p/10885082.html",target:"_blank",rel:"noopener noreferrer"},b=p(`<h3 id="创建目录并进入目录" tabindex="-1"><a class="header-anchor" href="#创建目录并进入目录" aria-hidden="true">#</a> 创建目录并进入目录</h3><p>可以手动创建也可以用命令创建</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">mkdir</span> my-blog
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="乱码问题" tabindex="-1"><a class="header-anchor" href="#乱码问题" aria-hidden="true">#</a> 乱码问题</h3><p>如果整个流程跑下来，页面出现乱码，<code>请用记事本方式打开乱码的 markdown 文件，另存为的同时修改文件编码为 UTF-8 即可</code>。我发现凡是用命令创建的文件都会乱码，手动创建的不会。</p><figure><img src="https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a8244d8b30694191bd0487dc935f74e5~tplv-k3u1fbpfcp-watermark.image?" alt="b5eb608343cf82839824f03add53aec.png" tabindex="0" loading="lazy"><figcaption>b5eb608343cf82839824f03add53aec.png</figcaption></figure><h2 id="进阶" tabindex="-1"><a class="header-anchor" href="#进阶" aria-hidden="true">#</a> 进阶</h2><p>简单的demo完成后，该开始“装饰”一下网站了。我们根据官方提供的 <code>默认主题</code> 进行“装饰”。</p><p>为了方便理解该框架，我用普通vue项目做了下对比——</p><figure><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e6f911d09fc142898cfd52503f2da2c3~tplv-k3u1fbpfcp-watermark.image?" alt="微信截图20230601222750.png" tabindex="0" loading="lazy"><figcaption>微信截图_20230601222750.png</figcaption></figure><h3 id="站点配置" tabindex="-1"><a class="header-anchor" href="#站点配置" aria-hidden="true">#</a> 站点配置</h3><p>在.vuepress文件夹下创建config.js配置文件，这是整个网站的配置文件，支持 <code>.vuepress/config.js</code> 和 <code>.vuepress/config.ts</code> ，下面是基本的站点配置</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token operator">...</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>看看效果，可以根据自己的需要搭配着用</p><p align="center"><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/74587f7933d94673ab09bc044762502f~tplv-k3u1fbpfcp-watermark.image?" alt="下拉.png"></p><p align="center">下拉 - children为数组</p><hr><p align="center"><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ee8d087a638d4e8abb9d4331a1d57059~tplv-k3u1fbpfcp-watermark.image?" alt="下拉2.png"></p><p align="center">下拉 - children为对象数组</p><hr><p align="center"><img src="https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c64410e81dcf4a359b3fb4265a9c5a0e~tplv-k3u1fbpfcp-watermark.image?" alt="下拉嵌套.png"></p><p align="center">下拉嵌套</p><hr><h3 id="添加侧边栏" tabindex="-1"><a class="header-anchor" href="#添加侧边栏" aria-hidden="true">#</a> 添加侧边栏</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> defaultTheme <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;@vuepress/theme-default&#39;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token operator">...</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>配置完导航栏和侧边栏后，网站慢慢有那味了~看看效果图——</p><figure><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e05da6b7eb8d4415a5be224001cabdf1~tplv-k3u1fbpfcp-watermark.image?" alt="微信截图20230602205113.png" tabindex="0" loading="lazy"><figcaption>微信截图_20230602205113.png</figcaption></figure><h3 id="页面配置" tabindex="-1"><a class="header-anchor" href="#页面配置" aria-hidden="true">#</a> 页面配置</h3><p>页面可以通过 Frontmatter 配置，Frontmatter 必须在 Markdown 文件的顶部，并且被包裹在一对三短划线中间。</p>`,48),h={href:"https://v2.vuepress.vuejs.org/zh/reference/default-theme/frontmatter.html#%E9%A6%96%E9%A1%B5",target:"_blank",rel:"noopener noreferrer"},g=s("code",null,"home: true",-1),y=s("code",null,"docs/README.md",-1),f=p(`<div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
...
<span class="token punctuation">---</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8138798ac0d24e24ae8a864844732e98~tplv-k3u1fbpfcp-watermark.image?" alt="微信截图20230602214153.png" tabindex="0" loading="lazy"><figcaption>微信截图_20230602214153.png</figcaption></figure>`,2),x={href:"https://v2.vuepress.vuejs.org/zh/reference/frontmatter.html",target:"_blank",rel:"noopener noreferrer"},_=p(`<div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
...
└─ zh
 ...
 <span class="token punctuation">}</span>
  ...
  <span class="token operator">...</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>最后是md页面的内容，我这个语言渣渣就不展示了。（小声bb，网站没达到一定的知名度，这玩意就只能装X，就当是学学思路吧~）</p><h3 id="搜索框" tabindex="-1"><a class="header-anchor" href="#搜索框" aria-hidden="true">#</a> 搜索框</h3>`,11),j=s("code",null,"search",-1),w=s("code",null,"docsearch",-1),E={href:"https://docsearch.algolia.com/",target:"_blank",rel:"noopener noreferrer"},M={href:"https://docsearch.algolia.com/apply/",target:"_blank",rel:"noopener noreferrer"},z={href:"https://v2.vuepress.vuejs.org/zh/reference/plugin/docsearch.html#apikey",target:"_blank",rel:"noopener noreferrer"},P={href:"https://v2.vuepress.vuejs.org/zh/reference/plugin/docsearch.html#indexname",target:"_blank",rel:"noopener noreferrer"},V=p(`<p>安装插件然后在配置文件中配置plugins</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i <span class="token parameter variable">-D</span> @vuepress/plugin-search@next
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="部署成功" tabindex="-1"><a class="header-anchor" href="#部署成功" aria-hidden="true">#</a> 部署成功</h3><p>脚本执行成功后，代码就会被上传到指定仓库的gh-pages分支，gh-pages分支里的就是项目构建后的dist文件，你也可以把源码上传到master分支或其他分支作为项目源分支。</p><figure><img src="https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b252327772ec4009a933a35251cf64ab~tplv-k3u1fbpfcp-watermark.image?" alt="微信截图_20230614104252.png" tabindex="0" loading="lazy"><figcaption>微信截图_20230614104252.png</figcaption></figure><h3 id="注意事项" tabindex="-1"><a class="header-anchor" href="#注意事项" aria-hidden="true">#</a> 注意事项</h3>`,18),D={href:"https://blog.csdn.net/kangkanglhb88008/article/details/127947544",target:"_blank",rel:"noopener noreferrer"},q=s("code",null,"REMOTE HOST IDENTIFICATION HAS CHANGED",-1),S={href:"https://www.cnblogs.com/morango/p/17269515.html",target:"_blank",rel:"noopener noreferrer"},T=s("h2",{id:"总结",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#总结","aria-hidden":"true"},"#"),n(" 总结")],-1),R={href:"https://v2.vuepress.vuejs.org/zh/",target:"_blank",rel:"noopener noreferrer"};function I(B,C){const a=i("ExternalLinkIcon");return l(),o("div",null,[r,d,s("p",null,[n("最近发现了一个神奇的工具 "),s("a",u,[n("VuePress"),e(a)]),n(" ，它满足了我所有的需求")]),k,s("p",null,[n("需要满足"),v,n("，推荐一个好用的node版本管理工具 "),s("a",m,[n("NVM"),e(a)]),n(" ，可以对node版本进行下载/卸载/切换")]),b,s("p",null,[s("a",h,[n("首页"),e(a)]),n(" 配置 "),g,n(" 可以将该页面设定为首页，将下面代码复制到 "),y,n(" 里，就可以生成官方默认首页")]),f,s("p",null,[s("a",x,[n("普通页面"),e(a)]),n(" 普通页面也可以根据需要配置，如页面的标题，如果不设置默认是取文档的第一个h1作为标题")]),_,s("p",null,[n("官方提供了两个插件 "),j,n(),w,n(" ，前者是根据你的页面，在本地生成搜索索引，后者是将 "),s("a",E,[n("Algolia DocSearch"),e(a)]),n(" 集成到 VuePress 中，为你的文档网站提供搜索功能；前者能直接用，后者需要 "),s("a",M,[n("提交你的网站 URL"),e(a)]),n(" 来加入 DocSearch 项目，用 "),s("a",z,[n("apiKey"),e(a)]),n(" 和 "),s("a",P,[n("indexName"),e(a)]),n(" 去配置插件。")]),V,s("p",null,[n("如果你不喜欢默认的主题，还可以到 "),s("a",N,[n("NPM"),e(a)]),n(" 上下载更多主题，更厉害的还可以自己制作一个主题。")]),A,s("ul",null,[s("li",null,[s("p",null,[n("部署 Github Pages 首先得完成 "),s("a",D,[n("ssh的配置"),e(a)])])]),s("li",null,[s("p",null,[n("如果你之前配置过ssh，但是出现 "),q,n("，请看 "),s("a",S,[n("hosts过期问题"),e(a)])])])]),T,s("p",null,[n("至此一个自己的博客网站就完成啦，其实 "),s("a",R,[n("VuePress"),e(a)]),n(" 还有很多配置和玩法，我只不过是抛砖引玉，与大家共勉！")])])}const U=t(c,[["render",I],["__file","githubPages.html.vue"]]);export{U as default};
